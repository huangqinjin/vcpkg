...
if(CMD STREQUAL "BUILD")
    ...
    if (DEFINED ENV{VCPKG_CCACHE})
        set(ENV{CCACHE_DIR} "${VCPKG_ROOT_DIR}/.cache/ccache~")
        set(ENV{CCACHE_DEBUGDIR} "$ENV{CCACHE_DIR}/dbg")
        set(ENV{CCACHE_NAMESPACE} ${TARGET_TRIPLET})
        #set(ENV{CCACHE_DEBUG} 1)
        set(ENV{CMAKE_C_COMPILER_LAUNCHER} "$ENV{VCPKG_CCACHE}")
        set(ENV{CMAKE_CXX_COMPILER_LAUNCHER} "$ENV{VCPKG_CCACHE}")
    endif()
